...
clearBtn = Button(panelFrame, height = 2, text = 'Очистить')
beginBtn = Button(panelFrame, height = 2, text = 'Начать с начала')
...
learnBtn = Button(panelFrame, height = 2, text = 'Запомнить')
compareBtn = Button(panelFrame, height = 2, text = 'Распознать')
